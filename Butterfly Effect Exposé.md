...
Monica AI--boasting over 10 million users and charging $10-100/month for premium tiers--has been systematically defrauding its customer base by lying about the AI models powering its platform. This 13-month investigation is backed by a highly redundant web of evidence: authenticated direct-session WACZ recordings and public chat logs, immutably mirrored across traditional archiving services and a decentralized IPFS mesh network. Corporate intimidation tactics will not erase this data. Please help hold these actors accountable by sharing this exposé, along with its decentralized mirror. This investigation documents:
...
- **Registered security vulnerability:** CVE-2024-45989 allows attackers to exfiltrate users' entire chat histories via prompt injection. Third-party security researchers classified Manus' browser extension as "functionally indistinguishable from a sophisticated malware implant"
